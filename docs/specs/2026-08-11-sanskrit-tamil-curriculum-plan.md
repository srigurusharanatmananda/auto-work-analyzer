...
**Twenty-seventh pass — tranche 26: the next verified vocabulary slice.**
Wikner 6.B.4 supplies exactly seven Sanskrit lessons: the letters lā and bhe;
the words bālā ("the girl"), phalam ("the fruit"), and labhe ("I take"); and
two Level 4 sentences, one for each of the exercise translations. The letters
are added only because those source-quoted forms require them; the words and
sentences retain Wikner's printed English glosses. Tamil is intentionally
unchanged.
...
**Twenty-ninth pass — tranche 28: a dative-reading slice.** Wikner 6.B.2
(PDF p.60) supplies phalāya (“for fruit,” neuter dative singular); 6.B.4(c)1
(PDF p.62) and its Lesson 6 answer (PDF p.135) supply the sentence *bālā
aśvam vṛkṣam phalāya nayate* — “The girl leads the horse to the tree for
fruit.” No new letter was needed, so this is exactly two Sanskrit lessons.

Sanskrit: 269 → 271 lessons. Tamil: unchanged at 315. Level 4: 33 → 34
sentences.

**Thirtieth pass — tranche 29: an accusative-reading slice.** Wikner 6.B.2
(PDF p.60) supplies bālam (“the girl,” feminine accusative singular);
6.B.4(c)2 (PDF p.62) and its Lesson 6 answer (PDF p.135) supply *aśvaḥ naram
ca bālam ca vṛkṣam vahati* — “The horse carries the man and the girl to the
tree.” This exact sentence repeats च, so its manifest dependencies repeat the
existing word lesson as well; no letter lesson was needed.

Sanskrit: 271 → 273 lessons. Tamil: unchanged at 315. Level 4: 34 → 35
sentences.

**Thirty-first pass — tranche 30: an ablative-reading slice.** Wikner 6.B.2
(PDF p.60) supplies bālāyāḥ (“from the girl,” feminine ablative singular);
6.B.4(c)3 (PDF p.62) and its Lesson 6 answer (PDF p.135) supply *narasya
aśvaḥ phalam bālāyāḥ labhate* — “The man's horse takes the fruit from the
girl.” No new letter was needed.

Sanskrit: 273 → 275 lessons. Tamil: unchanged at 315. Level 4: 35 → 36
sentences.

**Thirty-second pass — tranche 31: a genitive/plural-reading slice.** Wikner
6.B.2 (PDF p.60) supplies vṛkṣāṇām (“of the trees,” genitive plural), phalāni
(“fruits,” neuter plural), and labhete (“they two take”); 6.B.4(c)4 (PDF p.62)
and its Lesson 6 answer (PDF p.135) supply *narau vṛkṣāṇām phalāni aśvam
labhete* — “The men (two) take the fruit (pl.) of the trees (pl.) to the
horse.” No new letter was needed.

Sanskrit: 275 → 279 lessons. Tamil: unchanged at 315. Level 4: 36 → 37
sentences.

**Thirty-third pass — tranche 32: a plural/instrumental-reading slice.**
Wikner 6.B.2 (PDF p.60) supplies bālāḥ (“the girls,” feminine nominative
plural); 6.B.4(c)5 (PDF p.62) and its Lesson 6 answer (PDF p.135) supply
*bālāḥ narān phalāni aśvena nayante* — “The girls (pl.) lead the men (pl.)
to the fruit (pl.) by horse.” This added the one needed combined letter śve
for the instrumental aśvena; narān, phalāni, and nayante were already taught.

Sanskrit: 279 → 283 lessons. Tamil: unchanged at 315. Level 4: 37 → 38
sentences.

**Thirty-fourth pass — tranche 33: a dual-destination reading slice.** Wikner
6.B.4(c)7 (PDF p.62) and its Lesson 6 answer (PDF p.135) supply *vṛkṣau
gacchāmi ca phalāni labhe* — “I go to the trees (two) and take the fruit
(pl.).” This added the two needed combined letters kṣau and cchā, then the
dual accusative vṛkṣau and the first-person form gacchāmi; ca, phalāni, and
labhe were already taught.

Sanskrit: 283 → 288 lessons. Tamil: unchanged at 315. Level 4: 38 → 39
sentences.

**Thirty-fifth pass — tranche 34: a dual-fruit reading slice.** Wikner
6.B.2 (PDF p.60) supplies phale (“the two fruits,” neuter dual) and bālāyai
(“for the girl,” feminine dative singular); 6.B.4(c)8 (PDF p.62) and its
Lesson 6 answer (PDF p.135) supply *naraḥ phale vṛkṣāt bālāyai vahati* —
“The man carries the fruit (two) from the tree for the girl.” This added the
one needed combined letter yai and the three new case-form words.

Sanskrit: 288 → 293 lessons. Tamil: unchanged at 315. Level 4: 39 → 40
sentences.

**Thirty-sixth pass — tranche 35: a possessive-tree reading sentence.**
Wikner 6.B.4(c)9 (PDF p.62) and its Lesson 6 answer (PDF p.135) supply
*bāle phalāni narasya vṛkṣāt labhete* — “The girls (two) take the fruit
(pl.) from the man’s tree.” All five word forms were already taught, so this
sentence-only tranche adds no new letter or vocabulary lesson.
...
*Rewritten after tranche 35, which added the next possessive-tree reading sentence from the
...
1. **Make Level 4 read like Level 4.** It is populated (41 sentences) but 25
   ...
   declensions needed for real prose; bālā, phalam, labhe, bāle, vṛkṣeṣu,
   vṛkṣāṇām, phalāni, labhete, bālāḥ, aśvena, vṛkṣau, gacchāmi, phale,
   vṛkṣāt, bālāyai, and the possessive-tree sentence
   are now taught. This is vocabulary work, not an immediate re-leveling of
   the existing 41 sentences. Prefer real sentences over permutations when new source-quoted

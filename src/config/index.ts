...
export function getClickUpConfig(): ClickUpConfig {
  ...
  if (!teamId || !apiKey) {
    throw new Error(
      "ClickUp credentials not configured. Please set CLICKUP_TEAM_ID and CLICKUP_API_KEY"
    );
  }
...
export function getAppConfig(): AppConfig {
  ...
  return {
    ...
    analysis: {
      ...
      timeEstimateMultiplier: parseFloat(
        process.env.TIME_ESTIMATE_MULTIPLIER || "1.0"
      ),
    },
    logging: {

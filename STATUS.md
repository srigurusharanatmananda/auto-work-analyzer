...
and its Level 4 sentence. Counted by running the real manifests, not
grep: **Sanskrit 273 lessons, Tamil 315**. All nine person/number cells of √sthā,
...
**Level 4 ("Reading Practice") holds 35 Sanskrit sentences — but read the
...
of the 35 are the same two-verb-plus-च shape (तिष्ठसि वदसि च, वदामि तिष्ठसि च,
...
28 added the dative-reading sentence from 6.B.4(c)1, and tranche 29 added
the accusative-reading sentence from 6.B.4(c)2; real prose

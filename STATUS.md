...
manifests, not grep: **Sanskrit 349 lessons, Tamil 315**. The next slice added
...
and the horse locative aśve ("on the horse") with the final Lesson 6 reading
sentence and five Lesson 5 reading sentences. The current Lesson 7 batch adds
vahatha (“you all carry”), vṛkṣasya (“of the tree”), vahanti (“they carry”),
and vṛkṣān (“the trees”), with three source-quoted Level 4 sentences. All nine person/number cells of √sthā,
...
**Level 4 ("Reading Practice") holds 62 Sanskrit sentences — but read the
...
of the 62 are the same two-verb-plus-च shape (तिष्ठसि वदसि च, वदामि तिष्ठसि च,

...
manifests, not grep: **Sanskrit 297 lessons, Tamil 315**. The next slice adds
...
then the possessive-tree reading sentence, dual-carrying vahataḥ, and the
horse-carrying reading sentence. All nine person/number cells of √sthā,
...
**Level 4 ("Reading Practice") holds 43 Sanskrit sentences — but read the
...
of the 43 are the same two-verb-plus-च shape (तिष्ठसि वदसि च, वदामि तिष्ठसि च,
